...
public class LexiconFetcherBlueLetterImplTest {
  ...
  @Before
  public void setup() {
    lexiconFetcher = new LexiconFetcherBlueLetterImpl(apiConnector, true);
  }
  ...
  public void fetchInterlinear_byChapter() throws Exception {
    ...
    ImmutableList<Interlinear> interlinears = new LexiconFetcherBlueLetterImpl(apiConnector, false)
        .fetchInterlinear(new BibleBook().setName("Genesis"), 1, 1, 400);
  ...
  public void fetchInterlinear_byVerse_noStrongs() throws Exception {
    ...
    ImmutableList<Interlinear> interlinears =
        lexiconFetcher.fetchInterlinear(new BibleBook().setName("Genesis"), 14, 18, 18);
  ...
  public void getStrongsReferences_withNonTranslatedWord() throws Exception {
    ...
    ImmutableList<Interlinear> interlinears =
        lexiconFetcher.fetchInterlinear(new BibleBook().setName("Isaiah"), 7, 14, 14);
  ...
  public void getStrongsReferences_withMultiNonTranslatedWords() throws Exception {
    ...
    ImmutableList<Interlinear> interlinears =
        lexiconFetcher.fetchInterlinear(new BibleBook().setName("Isaiah"), 8, 3, 3);
