...
public class SunTimeUtilSunriseSunsetOrgTest {
  ...
  public void getSunTimeData() {
    when(apiConnector.sendGet(anyString())).thenReturn(
        "<html></body><h2>blah blah blah</h2><table id=\"month\"><col><col><col><col><col><col><col><col><col><col>" +
            "<tbody><tr class=\"headers\"><th rowspan=\"2\">Day</th><th rowspan=\"2\">Twilight start</th>\n" +
            "<th rowspan=\"2\">Sunrise</th><th rowspan=\"2\">Sunset</th><th rowspan=\"2\">Twilight end</th>\n" +
            "<th rowspan=\"2\">Day length</th><th rowspan=\"2\">Solar noon</th><th colspan=\"2\">Nautical twilight</th>" +
            "<th colspan=\"2\">Astronomical twilight</th></tr>\n" +
            "<tr class=\"headers\"><th>Start</th><th>End</th><th>Start</th><th>End</th></tr>" +
            "<tr class=\"day\" rel=\"2021-08-01\">\n" +
