...
public class MachineTranslationIntegrationTest {
  ...
  public void translate7Days() {
    ...
    assertThat(translations).containsExactly(
        ...
        "Genesis 1:2 and the earth was vain and void and darkness upon face deep and spirit Mighty Ones hovering upon face the waters",
        ...
        "Genesis 1:10 and he call Mighty Ones to dry land earth and to collection the waters call seas and he see Mighty Ones for good",
        ...
        "Genesis 1:12 and you bring out the earth grass herb from sowing seed to kind of it and tree made fruit which seed of him in it to kind of it and he see Mighty Ones for good",
        ...
        "Genesis 1:22 and he bless them Mighty Ones to say increase and multiply and fill of him you the waters in seas and the bird let multiply in earth",
        ...
        "Genesis 1:25 and he made Mighty Ones you lives the earth to kind and you the beast to kind and you all creeping the land to kind of it and he see Mighty Ones for good",
        "Genesis 1:26 and he said Mighty Ones we made man in image of us like likeness of us and he rule in fish the sea and in bird the heavens and in beast and in all the earth and in all the creeping the that move upon the earth",
        ...
        "Genesis 1:28 and he bless them Mighty Ones and he said to them Mighty Ones increase and multiply and fill of him you the earth and subdue of him and rule in fish the sea and in bird the heavens and in all live the that moves upon the earth",
  ...
  public void translateChoiceFew() {
    ...
    assertThat(translations).containsExactly(
        ...
        "Lev 25:4 and in year the sevenths shabbat shabbat of it let there be to earth shabbat to יהוה field of you not you sow and vineyard of you not you prune",
        "Exo 20:2 I יהוה Mighty Ones of you which the bring outss of you from earth Mizraim from house servants",
  ...
  public void translateEccChapter12() {
    ...
    assertThat(translations).containsExactly(
        ...
        "Ecc 12:6 until which not he far [UNK] sorrow the silver and you run burn offerings the gold and you break pitcher upon the fountain and we run the wheel unto the pit",
        "Ecc 12:7 and he return the dust upon the earth like that which was and the spirit you return unto the Mighty Ones which given",
        "Ecc 12:8 vanity vanitys said the preachers the all vanity",
        "Ecc 12:9 and more that which was preachers wise again teach knowledge you the people and give ear and search make straight proverbs the multiply",
        "Ecc 12:10 seek preachers to find words of desire and like return uprightness words of truth",
        "Ecc 12:11 words of wises like goads and like nails planters mans of assemblys given of him from shout one",
