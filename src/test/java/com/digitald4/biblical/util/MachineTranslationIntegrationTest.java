...
public class MachineTranslationIntegrationTest {
  ...
  private final LexiconFetcher lexiconFetcher = new LexiconFetcherBlueLetterImpl(apiConnector, true);
  ...
  public void translate7Days() {
    ...
    assertThat(translations).containsExactly(
        ...
        "Genesis 1:5 and he call Mighty Ones to light day and to darkness call night and there came to be evening and there came to be morning day united",
        ...
        "Genesis 1:7 and he made Mighty Ones you the firmament and he separate between the waters which under to firmament and between the waters which from upon to firmament and there came to be so",
        ...
        "Genesis 1:9 and he said Mighty Ones let be gathered the waters under the heavens unto places united and you see the dry land and there came to be so",
        ...
        "Genesis 1:14 and he said Mighty Ones let there be light source in firmament the heavens to the separation between the day and between the night and let it be to sign and to feasts and to days and years",
        "Genesis 1:15 and let it be to light in firmament the heavens to shine upon the earth and there came to be so",
        "Genesis 1:16 and he made Mighty Ones you two the light source the greats you the light the great to dominate the day and you the light the small to dominate the night and you the stars",
        ...
        "Genesis 1:21 and he created Mighty Ones you the dragons the greats and you all soul the live the tread which abound the waters to kind of them and you all bird wing to kind of it and he saw Mighty Ones for good",
        ...
        "Genesis 1:25 and he made Mighty Ones you live the earth to kind and you the beast to kind and you all creeping the land to kind of it and he saw Mighty Ones for good",
        ...
        "Genesis 1:28 and he bless them Mighty Ones and he said them Mighty Ones increase and multiply and fill of him you the earth and subdue and rule in fish the sea and in bird the heavens and in all live the tread upon the earth",
        "Genesis 1:29 and he said Mighty Ones behold given of me to them you all herb sow seed which upon face all the earth and you all the tree which in it fruit tree sow seed to them let there be to food",
        "Genesis 1:30 and to all live the earth and to all bird the heavens and to all that creeps upon the earth which in it soul live you all green herb to food and there came to be so",
        ...
        "Genesis 2:2 and he consume Mighty Ones in day the seventh work of him which made and he shabbat in day the seventh from all work of him which made",
  ...
  public void translateChoiceFew() {
    ImmutableList<String> translations =
        Stream.of("Isa 9:6", "Psa 83:18").map(this::translate).collect(toImmutableList());
    assertThat(translations).containsExactly(
        ...
        "Psa 83:18 and know of him for you name of you יהוה to alone of you high upon all the earth"
    );
  }
