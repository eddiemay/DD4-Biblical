...
public class ScriptureCacher {
  ...
  public static void main(String[] args) {
    if (args.length == 0) {
      System.err.println("Version required");
      System.exit(1);
    }

    new ScriptureCacher(new APIConnector(API_URL, API_VERSION, 100)).cache(args[0]);
  }
}
