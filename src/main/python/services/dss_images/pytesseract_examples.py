...
try:
  print(pytesseract.image_to_string(filename, lang='heb', timeout=2)) # Timeout after 2 seconds
  print(pytesseract.image_to_string(filename, lang='heb', timeout=0.5)) # Timeout after half a second
